  ...
  if (!activeChat) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-gray-400 transition-all duration-500 opacity-90 hover:opacity-100">
        <div className="p-8 rounded-xl bg-gray-800 bg-opacity-50 shadow-2xl transform transition-transform duration-300 hover:scale-105 max-w-md w-full mx-4 backdrop-blur-sm">
          <svg
